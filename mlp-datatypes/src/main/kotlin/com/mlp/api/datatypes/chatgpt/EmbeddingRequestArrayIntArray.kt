 ...
 * @param input 
 */
data class EmbeddingRequestArrayIntArray(

    @Schema(example = "null", required = true, description = "")
    @get:JsonProperty("input", required = true) override val input: kotlin.collections.List<kotlin.collections.List<kotlin.Int>>,
