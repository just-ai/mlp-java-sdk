...
/**
* 
* Values: CHAT_COMPLETIONS,RESPONSES,REALTIME,ASSISTANTS,BATCH_PROCESSING,FINE_TUNING,EMBEDDINGS,IMAGE_GENERATION,IMAGE_EDIT,SPEECH_GENERATION,TRANSCRIPTION,SPEECH_TO_TEXT,MODERATIONS,COMPLETIONS,VIDEO_GENERATION,MUSIC_GENERATION,DECISIONS
*/
enum class ModelRequestType(val value: kotlin.String) {
    ...
    @JsonProperty("VIDEO_GENERATION") VIDEO_GENERATION("VIDEO_GENERATION"),
    @JsonProperty("MUSIC_GENERATION") MUSIC_GENERATION("MUSIC_GENERATION"),
    @JsonProperty("DECISIONS") DECISIONS("DECISIONS")
}
